...
export const bowlSizeRules: BowlSizeRule[] = [
  { size: 'small', name: 'Pequeño', price: 18900, maxBases: 1, maxProteins: 1, maxAcompanantes: 4 },
  { size: 'medium', name: 'Mediano', price: 24900, maxBases: 1, maxProteins: 2, maxAcompanantes: 5 },
  { size: 'large', name: 'Grande', price: 29900, maxBases: 2, maxProteins: 2, maxAcompanantes: 6 },
];
...
export const ingredients: Ingredient[] = [
  ...
  { id: 'protein-salmon', name: 'Salmón', type: 'protein', calories: 180, isGlutenFree: true, price: 5000 },
  { id: 'protein-tuna', name: 'Atún Sellado', type: 'protein', calories: 150, isGlutenFree: true, price: 4000 },
  { id: 'protein-shrimp', name: 'Camarones', type: 'protein', calories: 100, isGlutenFree: true, price: 6000 },
  { id: 'protein-tofu', name: 'Tofu Marinado', type: 'protein', calories: 80, isVegan: true, isGlutenFree: true },
  { id: 'protein-beef', name: 'Carne Asada', type: 'protein', calories: 200, isGlutenFree: true, price: 3000 },
...
export const modifiers: Modifier[] = [
  { id: 'mod-extra-cheese', name: 'Extra Queso', price: 3000, productId: 'chilli-burger-1' },
  { id: 'mod-bacon', name: 'Agregar Tocino', price: 4000, productId: 'chilli-burger-1' },
  { id: 'mod-avocado', name: 'Agregar Aguacate', price: 5000, productId: 'chilli-burger-1' },
  { id: 'mod-large-drink', name: 'Bebida Grande', price: 2000, productId: 'bev-1' },
];
